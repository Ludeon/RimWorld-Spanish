...
3. Comprueba, en la línea 20, que tienes la rama adecuada seleccionada. Por defecto se encuentra `master`, pero deberás modificarla a la versión que te interese entre las actualmente disponibles (`v1.4`, `v1.5`, `v1.6`, `master`, `test-translations`).
...
2. Abre un terminal en el directorio donde bajaste el script (`cd ~/Descargas`).
