...
rmdir .\Data\Core\Languages\"Spanish (GitHub)"  /S /Q
rmdir .\Data\Royalty\Languages\"Spanish (GitHub)"  /S /Q
...
mkdir .\Data\Ideology\Languages\"Spanish (GitHub)"
...
xcopy .\RimWorld-Spanish-master\Ideology\* .\Data\Ideology\Languages\"Spanish (GitHub)"\ /E /Y
